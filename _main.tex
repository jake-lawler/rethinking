...
\CommentTok{\# I.e. For each mu and sigma combination, create a vector length 352 }
\CommentTok{\# (the number of heights in the data set) }
...
\includegraphics{05-many_variables_files/figure-latex/unnamed-chunk-9-1.pdf}
...
\includegraphics{06-haunted_dag_files/figure-latex/unnamed-chunk-4-1.pdf}
...
\addcontentsline{toc}{subsection}{Post-Treatment Bias}
...
\includegraphics{06-haunted_dag_files/figure-latex/unnamed-chunk-15-1.pdf}
...
\includegraphics{06-haunted_dag_files/figure-latex/unnamed-chunk-17-1.pdf}
...
\addcontentsline{toc}{subsection}{Collider Bias}
...
\includegraphics{06-haunted_dag_files/figure-latex/unnamed-chunk-25-1.pdf}
...
\includegraphics{06-haunted_dag_files/figure-latex/unnamed-chunk-31-1.pdf}
...
\includegraphics{06-haunted_dag_files/figure-latex/unnamed-chunk-31-2.pdf}
...
\includegraphics{06-haunted_dag_files/figure-latex/unnamed-chunk-33-1.pdf}
...
\includegraphics{06-haunted_dag_files/figure-latex/unnamed-chunk-34-1.pdf}
...
\includegraphics{06-haunted_dag_files/figure-latex/unnamed-chunk-35-1.pdf}
...
\includegraphics{06-haunted_dag_files/figure-latex/unnamed-chunk-36-1.pdf}
...
\includegraphics{06-haunted_dag_files/figure-latex/unnamed-chunk-37-1.pdf}
...
\includegraphics{06-haunted_dag_files/figure-latex/unnamed-chunk-39-1.pdf}
...
\includegraphics{06-haunted_dag_files/figure-latex/unnamed-chunk-41-1.pdf}
...
\includegraphics{06-haunted_dag_files/figure-latex/unnamed-chunk-42-1.pdf}
...
\includegraphics{06-haunted_dag_files/figure-latex/unnamed-chunk-43-1.pdf}

\begin{verbatim}
##  {}
\end{verbatim}

\includegraphics{06-haunted_dag_files/figure-latex/unnamed-chunk-43-2.pdf}
...
\includegraphics{06-haunted_dag_files/figure-latex/unnamed-chunk-44-1.pdf}
...
\includegraphics{06-haunted_dag_files/figure-latex/unnamed-chunk-45-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# we define a function for the empirical variace}
\CommentTok{\# since var() in R uses the denominator n{-}1}
\NormalTok{var\_n }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(vector)\{}
  \FunctionTok{mean}\NormalTok{((}\FunctionTok{mean}\NormalTok{(vector)}\SpecialCharTok{{-}}\NormalTok{vector)}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)}
\NormalTok{\}}

\CommentTok{\# we define a function to produce the R\^{}2 of each model we\textquotesingle{}ll be fitting}
\NormalTok{hominin\_r\_squared }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(model)\{}
  
\NormalTok{  pred\_hominin }\OtherTok{\textless{}{-}} \FunctionTok{add\_predicted\_draws}\NormalTok{(data\_hominin,model)}\SpecialCharTok{\%\textgreater{}\%} \CommentTok{\# predict brain volume using observed body weights}
  \FunctionTok{group\_by}\NormalTok{(species,vol\_std)}\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{pred\_vol=}\FunctionTok{mean}\NormalTok{(.prediction), }\AttributeTok{.groups =} \StringTok{"keep"}\NormalTok{)}\SpecialCharTok{\%\textgreater{}\%} \CommentTok{\# we\textquotesingle{}ll use the mean of our predictions}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{residuals =}\NormalTok{ pred\_vol}\SpecialCharTok{{-}}\NormalTok{vol\_std)}
  
  \DecValTok{1} \SpecialCharTok{{-}} \FunctionTok{var\_n}\NormalTok{(pred\_hominin}\SpecialCharTok{$}\NormalTok{residuals)}\SpecialCharTok{/}\FunctionTok{var\_n}\NormalTok{(pred\_hominin}\SpecialCharTok{$}\NormalTok{vol\_std) }\CommentTok{\# our R\^{}2 calc}
\NormalTok{\}}

\FunctionTok{hominin\_r\_squared}\NormalTok{(m7\_1)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{draws\_hominin}\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{brain\_vol =}\NormalTok{ .prediction }\SpecialCharTok{*} \FunctionTok{max}\NormalTok{(data\_hominin}\SpecialCharTok{$}\NormalTok{brain\_vol), }\CommentTok{\# undoing the previous transformations}
         \AttributeTok{body\_size =}\NormalTok{ mass\_std}\SpecialCharTok{*}\FunctionTok{sd}\NormalTok{(data\_hominin}\SpecialCharTok{$}\NormalTok{body\_size)}\SpecialCharTok{+}\FunctionTok{mean}\NormalTok{(data\_hominin}\SpecialCharTok{$}\NormalTok{body\_size))}\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ body\_size, }\AttributeTok{y=}\NormalTok{brain\_vol)) }\SpecialCharTok{+}
  \FunctionTok{stat\_lineribbon}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ brain\_vol)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{data =}\NormalTok{ data\_hominin, }\AttributeTok{colour =}\NormalTok{ tol\_light[[}\DecValTok{4}\NormalTok{]],}\AttributeTok{size=}\DecValTok{2}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_text}\NormalTok{(}\AttributeTok{data=}\NormalTok{values\_r\_square, }\CommentTok{\# adding our R\^{}2 lables from earlier}
            \FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\DecValTok{40}\NormalTok{,}\AttributeTok{y=}\DecValTok{1900}\NormalTok{,}\AttributeTok{label=}\NormalTok{labels),}\AttributeTok{size=}\DecValTok{3}\NormalTok{)}\SpecialCharTok{+}
...
\addcontentsline{toc}{subsection}{Predicting Predicitve Accuracy}
...
\includegraphics{07-ulysses_files/figure-latex/unnamed-chunk-15-1.pdf}
...
\includegraphics{07-ulysses_files/figure-latex/unnamed-chunk-17-1.pdf}
...
\includegraphics{07-ulysses_files/figure-latex/unnamed-chunk-19-1.pdf}
...
\includegraphics{07-ulysses_files/figure-latex/unnamed-chunk-20-1.pdf}
...
\includegraphics{07-ulysses_files/figure-latex/unnamed-chunk-27-1.pdf}
...
\includegraphics{08-conditional_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# we generate 100 samples from each of our prior distributions}
\NormalTok{priors\_rugged }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}\AttributeTok{a=}\FunctionTok{c}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(}\DecValTok{100}\NormalTok{, }\AttributeTok{mean =} \DecValTok{1}\NormalTok{, }\AttributeTok{sd=}\DecValTok{1}\NormalTok{),}\FunctionTok{rnorm}\NormalTok{(}\DecValTok{100}\NormalTok{, }\AttributeTok{mean =} \DecValTok{1}\NormalTok{, }\AttributeTok{sd=}\FloatTok{0.1}\NormalTok{)),}
                        \AttributeTok{b=}\FunctionTok{c}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(}\DecValTok{100}\NormalTok{, }\AttributeTok{mean =} \DecValTok{0}\NormalTok{, }\AttributeTok{sd=}\DecValTok{1}\NormalTok{),}\FunctionTok{rnorm}\NormalTok{(}\DecValTok{100}\NormalTok{, }\AttributeTok{mean =} \DecValTok{0}\NormalTok{, }\AttributeTok{sd=}\FloatTok{0.3}\NormalTok{)),}
                        \AttributeTok{prior\_set =} \FunctionTok{c}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\StringTok{"prior\_set\_1"}\NormalTok{,}\DecValTok{100}\NormalTok{),}\FunctionTok{rep}\NormalTok{(}\StringTok{"prior\_set\_2"}\NormalTok{,}\DecValTok{100}\NormalTok{)))}

\CommentTok{\# we plot the lines they imply}
\FunctionTok{ggplot}\NormalTok{(priors\_rugged)}\SpecialCharTok{+}
  \FunctionTok{geom\_abline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{slope =}\NormalTok{ b,}
                  \AttributeTok{intercept =}\NormalTok{ a }\SpecialCharTok{{-}}\NormalTok{ b}\SpecialCharTok{*}\FunctionTok{mean}\NormalTok{(data\_rugged}\SpecialCharTok{$}\NormalTok{rugged\_std) ),}\AttributeTok{alpha=}\FloatTok{0.5}\NormalTok{)}\SpecialCharTok{+} \CommentTok{\# setting intercept so that x{-}axis ranges over (0,1)}
  \FunctionTok{xlim}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{ylim}\NormalTok{(}\FloatTok{0.5}\NormalTok{, }\FloatTok{1.5}\NormalTok{)}\SpecialCharTok{+}
  ...
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"log GDP (standardised)"}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{facet\_wrap}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{prior\_set) }
\end{Highlighting}
\end{Shaded}

\includegraphics{08-conditional_files/figure-latex/unnamed-chunk-5-1.pdf}
...
\includegraphics{08-conditional_files/figure-latex/unnamed-chunk-9-1.pdf}
...
\includegraphics{08-conditional_files/figure-latex/unnamed-chunk-12-1.pdf}
...
\includegraphics{08-conditional_files/figure-latex/unnamed-chunk-16-1.pdf}
...
\addcontentsline{toc}{subsection}{A Metropolis Algorithm}
...
\includegraphics[width=1\linewidth]{animations\09_anim_metrop}
...
\addcontentsline{toc}{subsection}{Gibbs Sampling and Hamiltonian Monte Carlo}
...
\includegraphics{09-markov_chain_files/figure-latex/unnamed-chunk-16-1.pdf}
...
\includegraphics{09-markov_chain_files/figure-latex/unnamed-chunk-19-1.pdf}
...
\addcontentsline{toc}{subsection}{Care and Feeding of Your Markov Chain}
