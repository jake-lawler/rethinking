...
There is also the loo package for WAIC and PSIS. [Here's](http://mc-stan.org/loo/articles/loo2-example.html) the vignette.

Revisit this.

One last thing I'll need is a way to to prior predictive checks with Stan models. Here are some resources. 

[Stan User Guide](https://mc-stan.org/docs/2_27/stan-users-guide/prior-predictive-checks.html#coding-prior-predictive-checks-in-stan)
